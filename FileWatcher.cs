...
namespace UntitledCanvas
{
    ...
    //https://github.com/dotnet/aspnetcore/blob/v5.0.0/src/Tools/dotnet-watch/src/Internal/FileWatcher/DotnetFileWatcher.cs
    internal class FileWatcher : IDisposable
    {
        ...
        public FileWatcher(string watchedDirectory)
            : this(watchedDirectory, DefaultWatcherFactory)
        {
        }

        internal FileWatcher(string watchedDirectory, Func<string, FileSystemWatcher> fileSystemWatcherFactory)
        {
